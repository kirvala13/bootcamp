    ...
    <div className='personal__container covid'>
      <div className='cordinates-container insight'>
        ...
        <div className='radio-Question'>
          ...
          <form>
            <label>
              <input type="radio" name="name" value="true" onChange={(e)=> setOrganize(e.target.value)} />
              Yes
            </label>
            <label>
              <input type="radio" name="name" value="false" onChange={(e)=> setOrganize(e.target.value)}/>
              No
            </label>
          </form>
        </div>
        ...
        <div className='pagination'>
              ...
              <div></div>
              <Link to="submited" onClick={insightClick}><img src={next} alt="nextbtn" /></Link>
            </div>
      </div>
